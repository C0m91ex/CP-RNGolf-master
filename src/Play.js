class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.input.on('pointerdown', (pointer) => {
            ...
            this.ball.body.setVelocityX(shotDirectionX * Phaser.Math.Between(this.SHOT_VELOCITY_X / 2, this.SHOT_VELOCITY_X))
    ...
    update() {
        ...
        // If the one-way wall hits the left or right boundary, reverse its direction
        if (this.oneWay.x <= 0 || this.oneWay.x >= width - this.oneWay.width) {
            this.oneWay.body.setVelocityX(-this.oneWay.body.velocity.x);
        }
    }
}
/*
